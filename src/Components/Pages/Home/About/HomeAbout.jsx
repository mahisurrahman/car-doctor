        ...
        <div className="min-h-screen mt-[100px]">
            <div className="flex flex-row gap-">
                ...
                <div className='w-1/2'>
                    ...
                    <p className="pt-8 text-lg font-thin tracking-widest">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
